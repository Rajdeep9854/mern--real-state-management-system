              ...
              <div className="flex flex-col flex-1 gap-4">
                  ...
                  <div className="flex  gap-4">
                      ...
                      <button
                          ...
                          className='p-3 uppercase border border-green-700 
                  ...
                  {formData.imageUrls.length > 0 && formData.imageUrls.map((url,index) => {
                      return <div key={ url} className="flex justify-between p-3 border item-center ">
                          ...
                          <button
                              ...
                              rounded-lg font-bold uppercase hover:opacity-95'
                              onClick={()=>handleRemoveImage(index)}
                          >Delete</button>
                      </div>
                  }) }
                  <button className='p-3 bg-slate-700 
                  text-white rounded-lg uppercase hover:opacity-95'>Create Listing</button>
